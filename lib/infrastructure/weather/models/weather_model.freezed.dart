...
abstract class _Clouds implements Clouds {
  factory _Clouds({required int all}) = _$_Clouds;
...
class _$_Coord implements _Coord {
  _$_Coord({required this.lon, required this.lat});
...
class _$_Wind implements _Wind {
  _$_Wind({required this.speed, required this.deg});
