...
import 'application/auth/auth_login/auth_login_bloc.dart' as _i11;
import 'domain/auth/i_auth_repository.dart' as _i5;
import 'domain/weather/i_weather_repository.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i7.IWeatherRepository>(
      () => _i8.WeatherRepository(get<_i9.INetworkService>()));
  gh.factory<_i10.AuthBloc>(() => _i10.AuthBloc(get<_i5.IAuthRepository>()));
  gh.factory<_i11.AuthLoginBloc>(
      () => _i11.AuthLoginBloc(get<_i5.IAuthRepository>()));
  return get;
}
